...
docker buildx build . -t ghcr.io/karlamonterrubiog/comprisksvignettes:latest --platform linux/arm64 --cpuset-cpus 0-9 --load

# Build ARM and x86 images and push to GitHub Container Registry
docker buildx build . -t ghcr.io/karlamonterrubiog/comprisksvignettes:latest --platform linux/arm64,linux/amd64 --cpuset-cpus 0-9 --push
