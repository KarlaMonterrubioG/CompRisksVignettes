...
## The `CFC` package
The cause-specific framework for competing risks (CFC) @Mahari2019Bayesian permits to compute adjusted cause-specific CIFs through the `cfc.survreg` function. The package permits to fit both, parametric and nonparametric models (see `survreg.distributions` for available choices).
