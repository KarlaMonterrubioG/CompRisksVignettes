...
clinical stage 2 increases the cause-specific hazard (rate) of relapse by 38.4%
...
instance going from 30-40 years, i.e. a 10-year increase will result in a 18.4%
...
predict the occurrenceof the second event type, use `cause = 2` in the code 
...
shown below, where we see that lasso selects age and chemotherapy treatment.
