...
Note that our covariates now correspond to binary indicators (1 or 0) of a specific
level of the original factor variables. In order to use this design matrix, we
