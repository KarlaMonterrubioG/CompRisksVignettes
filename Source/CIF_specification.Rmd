...
```{r, fig.dim=c(6,4)}
plot(cutoffs, pseudo[109, ], type = "b", xlab = "Time", ylab = "Pseudo-value")
plot(cutoffs, pseudo[1, ], type = "b", xlab = "Time", ylab = "Pseudo-value")
plot(cutoffs, pseudo[18, ], type = "b", xlab = "Time", ylab = "Pseudo-value")
plot(cutoffs, pseudo[149, ], type = "b", xlab = "Time", ylab = "Pseudo-value")
```
