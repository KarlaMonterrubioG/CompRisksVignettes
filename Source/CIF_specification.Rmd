...
The first column in CIF_hat corresponds to the `r nrow(CIF_hat)` unique event 
times and the remaining `r nrow(CIF_hat)-1` columns are the estimated CIFs for 
...
pred_DDP <- predict(fit_DDP, newdata = as.data.frame(hd_test[c(1, 2), 1:6]))
```
